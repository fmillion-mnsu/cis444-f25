> If you're looking for documentation on **accessing  MongoDB from SQL Server**, see the Polybase documentation for [MongoDB](../LINKED-MONGO-POLYBASE.md) in this repository.
...
# Accessing Microsoft SQL Server from Python

This code will show you how you can access MS SQL from Python. It will demonstrate running a few queries as well as interacting with both databases simultaneously.
...
3. [Open the project](#open-the-project-in-your-editor) in PyCharm (or your editor of choice).
...
Download the repository by [**clicking this link**](https://github.com/fmillion-mnsu/cis444-f25/archive/refs/heads/master.zip).

The ZIP file contains a folder called `resources/python`. Extract this folder to somewhere on your system. When extracting, make sure you don't end up with a nested folder:

![Image showing cis444-f25 folder within cis444-f25 folder](../images/nested_folders.png)

> [!TIP]
> This screenshot is out of date.

If you see this, copy the inner `cis444-f25` folder out of the nested folder.

### Step 3 - Open the project in your editor

If you are using PyCharm, open the `cis444-f25` folder. (Note that depending on how you extracted the data, you may have a nested folder - e.g. `cis444-f25\cis444-f25`. You want to select the *inner* folder in this case.) If configured correctly PyCharm should offer to setup the environment for you. 
...
Once you've configured the settings, you should be able to run the code. If you are successful, you will see the output of a `SELECT` query run against SQL Server!
